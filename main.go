...
func init() {
	...
	_ = schedulermgrv1.AddToScheme(scheme)
...
func main() {
	...
	if err != nil {
		setupLog.Error(err, "unable to connect k8s cluster")
		os.Exit(1)
	}
	if err = (&controllers.LogicalClusterReconciler{
		Client:      mgr.GetClient(),
		ExtraClient: clientSet,
		Log:         ctrl.Log.WithName("controllers").WithName("LogicalCluster"),
